CREATE TRIGGER trg_PermiRole_Audit
ON PermiRole
...
BEGIN
    ...
    BEGIN
        ...
        SELECT @role_id = role_id, @entitycatalog_id = entitycatalog_id, @permission_id = permission_id
        FROM inserted;
    ...
    VALUES (@action_type, 'PermiRole', NULL, @permission_id, @role_id, @entitycatalog_id, @old_value, @new_value);
END;
